...
import glob
import pandas as pd
from Preprocess import reader,join_data
...
model.fit_generator(generator=traindata,steps_per_epoch=STEP_SIZE_TRAIN,epochs=50)
model.evaluate_generator(generator=testdata,steps=STEP_SIZE_TEST)